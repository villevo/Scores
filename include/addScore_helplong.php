...
Tämän sovelluksen tarkoitus on nopeuttaa viikkokisojen tulosten syöttöä.
...
<li>Tulostensyöttö lisää kaiken kilpailuun liittyvän automaattisesti joten kaikki ilmoittautumiset,maksut,kierrosten valinnat,lohkot,kilpailun lukitsemiset ymsyms. välivaiheet jää pois.<br></li>
...
<br>
<li><b>Kilpailut:</b> <u>Tulokset lisätään koko kisan kokonaistuloksena.</u> eli jos on esim. kahden kierroksen kisa niin kisakoneessa tulee olla tehtynä rata kahdelle kierrokselle esim "Oukku x2 par 60". Viikkokisa radoille suositellaan että väylien lukumääräksi laitetaan 1 ja väylän nimeksi "YHT". Kilpailun tulokset tarkastellaan kisakoneessa Leaderboard sivulla.</li>
<br>
<li><b>Rata:</b> Listassa näkyy kaikki radat mitä kisakoneeseen on laitettu. radan perässä on suluissa tasoituksiin liittyvät tiedot Rating ja Slope esim. (54/80) lisää tietoa tasoituksista alempana.</li>
<br>
